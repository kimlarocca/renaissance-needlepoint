...
class Zass_Font_Awesome {

	/**
	 * @var array Holds all styles and description - taken from vc_iconpicker_type_fontawesome()
	 */
	private static $fontawesome_icons = array(
		'Accessibility'       => array(
	...
	public static function getFontStylesAndDescriptionAsArray() {
		return self::$fontawesome_icons;
	}

	public static function getFontStylesAsArray() {
		$flattened_array = array();

		foreach ( self::$fontawesome_icons as $key => $value ) {
			foreach ( $value as $subkey => $subvalue ) {
				$flattened_array[ $key ][ $subkey ] = array_keys( $subvalue );
			}
		}

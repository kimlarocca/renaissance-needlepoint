...
(function ($) {
    $(document).ready(function () {
        ...
        jQuery('.zass_upload_image_button').on('click', function (event) {
            ...
            file_frame.on('select', function () {
                ...
                selection.map(function (attachment) {
                    ...
                    else if (optionId === 'zass_super_slider_ids' && attachment.sizes.zass_general_small_size) {
                        jQuery('#' + optionId + '_images').append('<img alt="" src="' + attachment.sizes.zass_general_small_size.url + '">');
                    }
                    else if (attachment.sizes.zass_general_medium_size) {
                        jQuery('#' + optionId + '_images').append('<img alt="" src="' + attachment.sizes.zass_general_medium_size.url + '">');
                    }
                    else {
                        jQuery('#' + optionId + '_images').append('<img alt="" src="' + attachment.url + '">');
                    }
        ...
        jQuery('a.zass_remove_image_link').on('click', function (event) {
        ...
        /**
         * Delete an zass featured image
         */
        jQuery('.zass_delete_image_button').on('click', function (event) {
        ...
        jQuery('#add_custom_sidebar').on('click', function (event) {
            ...
            if ($.trim(newSdbr) !== '') {
                ...
                if (currentSdbrs.search($.trim(newSdbr)) === -1) {
                    ...
                    jQuery('#zass_custom_sidebars_list').append(
                        '<div><a class="zass_del_sdbr" data-sidebar-name="' + newSdbr + '" href="#"></a>' + newSdbr + '</div>'
                    );
                }
                else {
                ...
                if ($.trim($('#sidebar_ids').val()) !== '') {
                    $('.zass_no_custom_sidebars').html('List of created custom sidebars:');
                }
            }
        });
         ...
         * Delete sidebar
         */
        $('#zass_custom_sidebars_list').delegate('.zass_del_sdbr', 'click', function (event) {
            event.preventDefault();

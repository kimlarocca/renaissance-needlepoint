...
(function ($) {
    ...
    zass_optionsframeworkMLU = {
        ...
        mediaUpload: function () {
            ...
            var formfield,
                ...
                tbframe_interval;
            // On Click
            $('input.zass_upload_button').on("click", function (e) {
    ...
    }; // End zass_optionsframeworkMLU Object // Don't remove this, or the sky will fall on your head.

    /*-----------------------------------------------------------------------------------*/
    /* Execute the above methods in the zass_optionsframeworkMLU object.
     /*-----------------------------------------------------------------------------------*/

    $(document).ready(function () {

        zass_optionsframeworkMLU.removeFile();
        zass_optionsframeworkMLU.recreateFileField();
        zass_optionsframeworkMLU.mediaUpload();

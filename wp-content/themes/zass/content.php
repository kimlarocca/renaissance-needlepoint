...
// If is latest posts
if (isset($zass_is_latest_posts) && $zass_is_latest_posts) { // If is latest post shortcode
    $zass_featured_image_size = 'zass-640x480';
}
...
<div id="post-<?php the_ID(); ?>" <?php post_class($zass_post_classes); ?>>
	...
	<div class="zass_post_data_holder<?php if (!$zass_show_author_avatar) echo ' zass-no-avatar' ?>">
		...
		<?php elseif (!is_search()): ?>
			...
			<?php if (isset($zass_is_latest_posts) && isset($zass_blogposts_param_hide_excerpt) && $zass_blogposts_param_hide_excerpt === 'no' || !isset($zass_blogposts_param_hide_excerpt)): ?>
				<div class="blog-post-excerpt">
					<?php
					// For latest post we set up excerpt of 20 words
					if (isset($zass_is_latest_posts) && $zass_is_latest_posts) {

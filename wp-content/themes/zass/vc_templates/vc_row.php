...
if (!empty($el_id)) {
	...
	$wrapper_attributes[] = 'id="' . esc_attr('zass_' . $unique_id) . '"';
	$row_id = 'zass_' . $unique_id;
}
if (!empty($full_width)) {
...
if (!empty($allow_overflow) && $allow_overflow == 'yes') {
	$css_classes[] = 'zass-visible-overlay';
}
if (!empty($fixed_background) && $fixed_background == 'yes') {
	$css_classes[] = 'zass-fixed-background';
}
if (!empty($point_down) && $point_down == 'yes') {
	$css_classes[] = 'zass-point-down';
}

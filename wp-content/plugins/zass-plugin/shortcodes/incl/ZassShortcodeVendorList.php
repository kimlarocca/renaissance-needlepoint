...
if (!class_exists('ZassShortcodeVendorList')) {

    class ZassShortcodeVendorList {
        /**
         * Filter vendor list
         * @global object $WCMp
        ...
        public static function output($atts) {
            global $WCMp;
            extract(shortcode_atts(array('orderby' => 'registered', 'order' => 'ASC', 'limit' => '', 'hide_order_by' => ''), $atts, 'zass_wcmp_vendorslist'));
	        $selected_category = '';
	        $sort_type = $orderby;

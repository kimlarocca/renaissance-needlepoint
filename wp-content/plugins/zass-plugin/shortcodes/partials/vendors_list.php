        ...
        <form name="vendor_sort" method="get">
            <div class="vendor_sort">
                <select class="select short" id="vendor_sort_type" name="vendor_sort_type">
                    ...
                    } ?> ><?php echo __('By date', 'zass-plugin'); ?></option>
                    <option value="name" <?php if ($sort_type == 'name') {
                        echo 'selected="selected"';
                    } ?> ><?php echo __('By Alphabetically', 'zass-plugin'); ?></option>
                    <option value="category" <?php if ($sort_type == 'category') {
                        echo 'selected="selected"';
                    } ?> ><?php echo __('By Category', 'zass-plugin'); ?></option>
                </select>
                <?php
                ...
                <input value="<?php echo __('Sort', 'zass-plugin'); ?>" type="submit">
            </div>
        </form>
	<?php endif; ?>
		...
		if ($vendor_info && is_array($vendor_info)) {
			foreach ($vendor_info as $vendor) {
				...
				<div class="wcmp_sorted_vendors">
					...
					<?php $button_text = apply_filters('wcmp_vendor_lists_single_button_text', $vendor['store_title']); ?>
			...
			_e('No vendor found!', 'zass-plugin');
		}
		?>
	</div>
</div>

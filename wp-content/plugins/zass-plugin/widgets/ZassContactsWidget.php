 ...
 * @author aatanasov
 */
class ZassContactsWidget extends WP_Widget {

	public function __construct() {
		$widget_ops = array('description' => esc_html__('Shows contact details', 'zass-plugin'));
		parent::__construct('zass_contacts_widget', 'Zass Contacts details', $widget_ops);
	}
	...
	public function form($instance) {
		// Defaults
		$defaults = array(
				'title' => esc_html__('Have a Question?', 'zass-plugin'),
				'worktime' => '',
				'address' => '',
				'phone' => '',
				'fax' => '',
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('worktime')); ?>"><?php esc_html_e('Store working time:', 'zass-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address:', 'zass-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone number:', 'zass-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('fax')); ?>"><?php esc_html_e('Fax number:', 'zass-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email address:', 'zass-plugin'); ?></label>
...
add_action('widgets_init', 'zass_register_zass_contacts_widget');
if (!function_exists('zass_register_zass_contacts_widget')) {

	function zass_register_zass_contacts_widget() {
		register_widget('ZassContactsWidget');
	}
